...
@section('admin-content')
    ...
    <div class="row my-5 " >
        <div class="mx-auto p-4" style="border: 1px solid #801419; border-radius: 4px;">
            <h1 class="page-header ">Create a Sub Category</h1>
            <form action="{{ route('store.subcategory') }}" method="POST">
                ...
                <div class="row mb-15px">
                    ...
                    <div class="col-md-6">
                        <label class="form-label col-form-label ">SubCategory Name</label>
                        <div class="">
                            <input type="text" required name="subcategory_name" class="form-control mb-5px" placeholder="Enter Category Name" />
                        </div>
                    </div>
                </div>
